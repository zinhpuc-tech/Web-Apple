...
<body>
    ...
    <main class="store-container">
        <h1 style="text-align:center; margin:40px 0;">iPhone</h1>

        <div class="filter-bar">
            <a href="iphone.php" class="<?= $filter=='all'?'active':'' ?>">Tất cả</a>
            <a href="iphone.php?filter=promax" class="<?= $filter=='promax'?'active':'' ?>">iPhone Pro Max</a>
            <a href="iphone.php?filter=pro" class="<?= $filter=='pro'?'active':'' ?>">iPhone Pro</a>
            <a href="iphone.php?filter=normal" class="<?= $filter=='normal'?'active':'' ?>">iPhone thường</a>
        </div>
        ...
        <div class="pagination">
            <?php if($page > 1): ?>
                <a href="iphone.php?page=<?= $page-1 ?>&filter=<?= $filter ?>">← Trang trước</a>
            <?php endif; ?>
            
            <span> Trang <?= $page ?> / <?= $total_pages ?> </span>
            
            <?php if($page < $total_pages): ?>
                <a href="iphone.php?page=<?= $page+1 ?>&filter=<?= $filter ?>">Trang sau →</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
    </main>
